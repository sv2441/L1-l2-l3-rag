...
OP_title=st.text_input("Enter the OP Title")
OP_description=st.text_input("Enter the OP Description")
OP= OP_title + " " + OP_description

if st.button("Generate Similarities"):
        similarity_finder(OP)
